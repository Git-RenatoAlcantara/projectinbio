    ...
    return (
        <div className="my-[150px] flex flex-col items-center gap-14">
            <div className="flex flex-col items-center gap-6">
                <h3 className="text-4xl font-bold text-white">Um valor acessível para todo</h3>
                <p className="text-content-body text-xl text-center">Junte-se à comunidade de cradores profissionais que já estão elevando sua <br />
                    presença onnline. Teste gratuitamente por{" "}
